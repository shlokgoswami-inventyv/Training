 ...
 */
export function correctListOfWagons([a,...args], missingWagons) {
  return [a,...missingWagons,...args];
}
 ...
 */
export function separateTimeOfArrival({timeOfArrival,...args}) {
  return [timeOfArrival,args];
}
